...
public class EmbeddingGeneratorFactoryTests
{
    ...
    {
        // Arrange
        var settings = new Dictionary<string, object> { ["ApiKey"] = "test", ["ModelId"] = "text-embedding-004" };
    ...
    {
        // Arrange
        var settings = new Dictionary<string, object> { ["ApiKey"] = null, ["ModelId"] = "text-embedding-004" };
    ...
    {
        // Arrange
        var settings = new Dictionary<string, object> { ["ApiKey"] = "test-key", ["ModelId"] = "text-embedding-004" };
        var factory = new EmbeddingGeneratorFactory(settings);
